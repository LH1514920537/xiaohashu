...
public class RelationServiceImpl implements RelationService {
    ...
    public PageResponse<FindFollowingUserRespVO> findFollowingList(FindFollowingListReqVO findFollowingListReqVO) {
        ...
        // 返参
        List<FindFollowingUserRespVO> findFollowingUserRspVOS = null;
    ...
    public PageResponse<FindFansUserRespVO> findFansList(FindFansListReqVO findFansListReqVO) {
        ...
        // 返参
        List<FindFansUserRespVO> findFansUserRspVOS = null;
     ...
     * @return
     */
    private List<FindFansUserRespVO> rpcUserServiceAndCountServiceAndDTO2VO(List<Long> userIds, List<FindFansUserRespVO> findFansUserRspVOS) {
        // RPC: 批量查询用户信息
        List<FindUserByIdRespDTO> findUserByIdRspDTOS = userRpcService.findByIds(userIds);
     ...
     * @return
     */
    private List<FindFollowingUserRespVO> rpcUserServiceAndDTO2VO(List<Long> userIds, List<FindFollowingUserRespVO> findFollowingUserRspVOS) {
        // RPC: 批量查询用户信息
        List<FindUserByIdRespDTO> findUserByIdRspDTOS = userRpcService.findByIds(userIds);
